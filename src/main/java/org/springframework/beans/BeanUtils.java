...
public abstract class BeanUtils {
	 ...
	 *
	 * @see com.whaleal.icefrog.core.util.ReflectUtil#newInstanceIfPossible(Class)
	 */
	 ...
	 *
	 * 新添加的方法  new
	 * @see  com.whaleal.icefrog.core.util.ReflectUtil#newInstance(Class, Object...)
	 */
	 ...
	 * nouse
	 * 
	 * @see com.whaleal.icefrog.core.util.ReflectUtil#getConstructor(Class, Class[]) 
	 */
	@Nullable
	public static <T> Constructor<T> findPrimaryConstructor(Class<T> clazz) {
		Assert.notNull(clazz, "Class must not be null");
		if (KotlinDetector.isKotlinType(clazz)) {
			Constructor<T> kotlinPrimaryConstructor = null;
	 ...
	 * @see  com.whaleal.icefrog.core.util.ReflectUtil#getPublicMethod(Class, String, Class[]) 
	 */
	@Nullable
